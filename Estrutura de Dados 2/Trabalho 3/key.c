...
Key sum_key_char(Key key, char c, int index, Key T[N]) {
    unsigned char str[C];    // String de valor 0
    for(int i = 0; i < C; i++) str[i] = 'a';

    str[index] = c; // String com chave apenas de 'c'
