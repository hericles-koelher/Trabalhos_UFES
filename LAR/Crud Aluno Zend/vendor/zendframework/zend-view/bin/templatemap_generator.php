...
configuration:
  ...
  'template_map' => include __DIR__ . '/template_map.module.config.php',
...
Examples:
  ...
  $ ../../../vendor/bin/templatemap_generator.php ../view > template_map.module.config.php

  # Create a template_map.module.config.php file in the Application module's
  # config directory, relative to the view directory, and only containing
  # .html.php files; overwrite any existing files:
  $ cd module/Application/config/
  $ ../../../vendor/bin/templatemap_generator.php ../view ../view/**/*.html.php > template_map.module.config.php

  # OR using find:
  $ ../../../vendor/bin/templatemap_generator.php \
  > ../view \
  > $(find ../view -name '*.html.php') > template_map.module.config.php
EOH;
